...
class Strings {
  ...
  static const String summary =
      'Detailed-oriented, responsible and committed software engineer, with a get it done, on time and high quality product spirit. 4+ years of experience defining requirements, designing, implementing and delivering complex web applications and mobile apps both iOS and Android using variety of programming languages and technologies.';
  static const String work_summary =
      'I have proven industrial experience for the 3 main frontend frameworks in current time; Angular, ReactJS and VueJS. \n\nAlso experienced in Vanilla JS, Redux, RxJs, React Native, PHP, Flutter, NodeJS, Ngnix, ASP.NET Core 3.1, HTML5, CSS/SASS and MySQL. I\'m knowledgeable about Spring Boot, Python and many other JavaScript frameworks and libraries. \n\nI worked mainly under hospitality and travel domains.';
  // skills:--------------------------------------------------------------------
